...
// texturas
#define sol_path "C:/IMPORTANTE/ubi/23_24/CompGrafica/sistema-solar-main/sistema-solar-main/Textures/2k_sun.jpg"
#define mercurio_path "C:/IMPORTANTE/ubi/23_24/CompGrafica/sistema-solar-main/sistema-solar-main/Textures/2k_mercury.jpg"
#define venus_path "C:/IMPORTANTE/ubi/23_24/CompGrafica/sistema-solar-main/sistema-solar-main/Textures/2k_venus_surface.jpg"
#define terra_path "C:/IMPORTANTE/ubi/23_24/CompGrafica/sistema-solar-main/sistema-solar-main/Textures/2k_earth.jpg"
#define lua_path "C:/IMPORTANTE/ubi/23_24/CompGrafica/sistema-solar-main/sistema-solar-main/Textures/2k_moon.jpg"
#define marte_path "C:/IMPORTANTE/ubi/23_24/CompGrafica/sistema-solar-main/sistema-solar-main/Textures/2k_mars.jpg"
#define jupiter_path "C:/IMPORTANTE/ubi/23_24/CompGrafica/sistema-solar-main/sistema-solar-main/Textures/2k_jupiter.jpg"
#define saturno_path "C:/IMPORTANTE/ubi/23_24/CompGrafica/sistema-solar-main/sistema-solar-main/Textures/2k_saturn.jpg"
#define urano_path "C:/IMPORTANTE/ubi/23_24/CompGrafica/sistema-solar-main/sistema-solar-main/Textures/2k_uranus.jpg"
#define neptuno_path "C:/IMPORTANTE/ubi/23_24/CompGrafica/sistema-solar-main/sistema-solar-main/Textures/2k_neptune.jpg"
...
int main()
{
    //Propriedades da esfera, camadas longitudinais e latitudinais
    int slices = 32;
    int stacks = 32;
    ...
    // Modelo de saturno
    Model ourModel("C:/IMPORTANTE/ubi/23_24/CompGrafica/sistema-solar-main/sistema-solar-main/Textures/Saturno/Saturn_v1_L3.123ca3750520-9e3a-478a-8d9b-97e3a212a44c/test.obj");
    ...
    vector <string> faces{
        "C:/IMPORTANTE/ubi/23_24/CompGrafica/sistema-solar-main/sistema-solar-main/Textures/Sky/right.jpg",
        "C:/IMPORTANTE/ubi/23_24/CompGrafica/sistema-solar-main/sistema-solar-main/Textures/Sky/left.jpg",
        "C:/IMPORTANTE/ubi/23_24/CompGrafica/sistema-solar-main/sistema-solar-main/Textures/Sky/top.jpg",
        "C:/IMPORTANTE/ubi/23_24/CompGrafica/sistema-solar-main/sistema-solar-main/Textures/Sky/bottom.jpg",
        "C:/IMPORTANTE/ubi/23_24/CompGrafica/sistema-solar-main/sistema-solar-main/Textures/Sky/front.jpg",
        "C:/IMPORTANTE/ubi/23_24/CompGrafica/sistema-solar-main/sistema-solar-main/Textures/Sky/back.jpg",
	};
    ...
    while (!glfwWindowShouldClose(window))
    {
		...
		posicaoPlanetas[5] = glm::vec3(xx, 3, zz);
		
		model = glm::translate(model, glm::vec3(xx, 5.0f, zz));
        //
        ...
        default:
            if (planeta == 0) {
                ...
                /*SCR_WIDTH = 1280;
                  SCR_HEIGHT = 720;*/
                renderText(TextShader, "Ajuda, prima H ", 1050.0f, SCR_HEIGHT - 690.0f, 0.50f, glm::vec3(0.145f, 0.705f, 0.745f));
...
void processInput(GLFWwindow* window)
{
    ...
    if (glfwGetKey(window, GLFW_KEY_H) == GLFW_PRESS) {
        ...
        std::cout << "0 - Reset da Camera" << std::endl;
        std::cout << "1 - Teleporta a Camera para Mercurio e bloqueia a camera no mesmo" << std::endl;
        std::cout << "2 - Teleporta a Camera para Venus e bloqueia a camera no mesmo" << std::endl;
        std::cout << "3 - Teleporta a Camera para Terra e bloqueia a camera no mesmo" << std::endl;
        std::cout << "4 - Teleporta a Camera para MArte e bloqueia a camera no mesmo" << std::endl;
        std::cout << "5 - Teleporta a Camera para Jupiter e bloqueia a camera no mesmo" << std::endl;
        std::cout << "6 - Teleporta a Camera para Saturno e bloqueia a camera no mesmo" << std::endl;
        std::cout << "7 - Teleporta a Camera para Urano e bloqueia a camera no mesmo" << std::endl;
        std::cout << "8 - Teleporta a Camera para Neptuno" << std::endl;
        std::cout << "W - Desloca a camera para a frente" << std::endl;
        std::cout << "A - Desloca a camera para a esquerda " << std::endl;
        std::cout << "S - Desloca a camera para tras" << std::endl;
        std::cout << "D - Desloca a camera para a direita" << std::endl;
        std::cout << "F - Liberta a camera" << std::endl;
        std::cout << "X - Zoom in " << std::endl;
        std::cout << "Z - Zoom out" << std::endl;
        std::cout << "ESC - Terminar o programa" << std::endl;
    }
